...
#define keymap_is_mac_system() ((get_highest_layer(default_layer_state) == _QWERTY) || (get_highest_layer(default_layer_state) == _RAISE))
#define keymap_is_base_layer() ((get_highest_layer(default_layer_state) == _COLEMAK)  || (get_highest_layer(default_layer_state) == _RAISE))
